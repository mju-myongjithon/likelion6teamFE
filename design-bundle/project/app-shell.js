...
(function () {
  ...
  function Sidebar({ active }) {
    ...
    return (
      React.createElement("aside", { style: { width: 240, flexShrink: 0, borderRight: "1px solid var(--hairline)", background: "var(--canvas)", padding: 20, boxSizing: "border-box", display: "flex", flexDirection: "column", height: "100%", minHeight: 0, overflowY: "auto" } },
        React.createElement("a", { href: "../app-home/Home.dc.html", style: { display: "flex", alignItems: "center", gap: 8, padding: "6px 8px", marginBottom: 24, textDecoration: "none" } },
        ...
        React.createElement("div", { style: { marginTop: "auto", padding: 16, background: "var(--surface-card)", borderRadius: "var(--radius-lg)" } },
          ...
          React.createElement("div", { style: { fontFamily: "var(--font-sans)", fontSize: 13, color: "var(--muted)", margin: "6px 0 12px", lineHeight: 1.4 } }, "무제한 신청과 우선 매칭"),
  ...
  function Header({ q, setQ, onAvatar }) {
    ...
    return (
      React.createElement("header", { style: { display: "flex", alignItems: "center", gap: 16, padding: "16px 28px", borderBottom: "1px solid var(--hairline)", background: "var(--canvas)" } },
