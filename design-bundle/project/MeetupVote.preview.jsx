...
const PIN_POS = { A: { left: "22%", top: "34%" }, B: { left: "58%", top: "18%" }, C: { left: "40%", top: "62%" } };

function MeetupVote() {
  const { ChatMessage, ChatThreadItem, Avatar, Button, IconButton, Input, Icon, Badge, Card, RatingStars } = getDS();
  const [activeThread, setActiveThread] = React.useState("algo");
