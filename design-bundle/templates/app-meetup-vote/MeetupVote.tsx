...
import type { PlaceVoteCardProps, PlaceVoteOption } from "../../components/chat/PlaceVoteCard";
...
interface VoteDS {
  ...
  PlaceVoteCard: React.FC<PlaceVoteCardProps>;
...
export function MeetupVote(): JSX.Element {
  const { ChatMessage, PlaceVoteCard, Avatar, Button, IconButton, Input, Icon, Badge } = getDS<VoteDS>();
