...
function GroupRow({ g, onClick }: { g: Group; onClick: () => void }): JSX.Element {
  const { Badge, Avatar, Icon } = getDS<MyGroupsDS>();
  return (
...
export function MyGroups(): JSX.Element {
  const { NavPillGroup } = getDS<MyGroupsDS>();
