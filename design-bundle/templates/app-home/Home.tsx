/**
 * Home — CampusLink 홈 추천 피드. Typed handoff source.
 * Composes the shared AppShell + DS cards. getDS() resolves the design system
 * at render; production handoff swaps it for real package imports.
 */
...
const MEETUPS: Array<Omit<MeetupCardProps, "style">> = [
...
const EVENTS: Array<Omit<EventCardProps, "style" | "onClick">> = [
...
export function Home(): JSX.Element {
  const { NavPillGroup, MeetupCard, EventCard, Callout, Badge } = getDS<HomeDS>();
