/**
 * MyGroupDetail.preview.jsx — RUNTIME MOUNT only. Canonical typed source: MyGroupDetail.tsx.
 */
...
function MyGroupDetail() {
  const { Button, Badge, Avatar, Icon } = getDS();
...
defineScreen("campuslink-my-group-detail", () => MyGroupDetail);
