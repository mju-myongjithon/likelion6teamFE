/**
 * ApplyComplete.preview.jsx — RUNTIME MOUNT only. Canonical typed source: ApplyComplete.tsx.
 */
const { getDS, AppShell, defineScreen } = window.CampusLinkAppShell;
React = window.React;

function ApplyComplete() {
  const { Button, Icon, Stepper } = getDS();
  return (
...
defineScreen("campuslink-apply-complete", () => ApplyComplete);
