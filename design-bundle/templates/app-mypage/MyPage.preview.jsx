/**
 * MyPage.preview.jsx — RUNTIME MOUNT only. Canonical typed source: MyPage.tsx.
 */
...
function MyPage() {
  const { Avatar, Badge, Button, Stat, Calendar, Icon } = getDS();
  return (
      ...
      <div style={{ padding: 28, maxWidth: 900 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: `1fr calc(var(--space-section) * 3 + var(--space-xl))`, gap: 20, alignItems: "start" }}>
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                ...
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "var(--space-sm) 0", borderBottom: i < 2 ? "1px solid var(--hairline-soft)" : "none" }}>
          ...
          <Calendar
            ...
            daysInMonth={28}
            today={9}
            events={[{ day: 1 }, { day: 8 }, { day: 9 }, { day: 15 }, { day: 22 }]}
          />
        </div>
      </div>
    </AppShell>
...
defineScreen("campuslink-mypage", () => MyPage);
