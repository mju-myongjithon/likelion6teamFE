/**
 * GroupDetail.preview.jsx — RUNTIME MOUNT only. Canonical typed source: GroupDetail.tsx.
 */
...
function GroupDetail() {
  const { Button, Input, Field, Badge, Avatar, Callout, Icon } = getDS();
    ...
    <AppShell active="home">
      <div style={{ padding: 28, maxWidth: 780 }}>
        ...
        <div style={{ display: "flex", gap: 12, position: "sticky", bottom: 0, background: "var(--canvas)", paddingTop: 8 }}>
          ...
          <Button variant="ghost" size="lg" onClick={() => { window.location.href = "../app-apply-failed/ApplyFailed.dc.html"; }}>신청(마감 예시)</Button>
        </div>
      </div>
    </AppShell>
  );
...
defineScreen("campuslink-group-detail", () => GroupDetail);
