/**
 * EventDetail — CampusLink 추천 행사 상세 + 참가 신청. Typed handoff source.
 */
...
interface ScheduleItem { date: string; title: string; time?: string; }
...
export function EventDetail(): JSX.Element {
  const { Button, Input, Field, Badge, Callout, Icon } = getDS<DS>();
