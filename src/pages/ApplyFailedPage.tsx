...
import { MeetupCard } from "../components/ds/cards/MeetupCard";
import { Icon } from "../components/ds/foundations/Icon";

/** 참여 신청 실패 화면 — 실패 사유 + 대안 추천. */
export function ApplyFailedPage(): JSX.Element {
      ...
      <div style={{ minHeight: "100%", display: "flex", alignItems: "center", justifyContent: "center", padding: "var(--space-xxl) var(--space-lg)" }}>
        <div style={{ width: "100%", maxWidth: 460, textAlign: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)" }}>
            <Button variant="primary" size="lg" fullWidth onClick={() => navigate("/home")}>다른 모임 추천받기</Button>
            <Button variant="secondary" size="lg" fullWidth onClick={() => navigate(-1)}>이전으로</Button>
          </div>
        </div>
      </div>
    </AppShell>
