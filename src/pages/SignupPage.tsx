  ...
  return (
    <AuthShell>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <Button variant="primary" size="lg" fullWidth iconRight={<Icon name="arrow-right" size={18} color="var(--on-primary)" />} onClick={() => navigate("/signup/password")}>인증하고 다음으로</Button>
